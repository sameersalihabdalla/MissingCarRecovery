...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $car_sql = "INSERT INTO cars (vin, plate_number, color, status, model, description, state, locality, reporter_phone, reporter_name, image_url1, image_url2, image_url3, p_date, manufactor) 
                VALUES ('$vin', '$plate_number', '$color', '$status', '$model', '$description', '$state', '$locality', '$reporter_phone', '$reporter_name', '$url1', '$url2', '$url3', '$datee', '$manufactor')";
